 ...
 */
public class FlatMapperException extends AbstractRuntimeException
{
  /**
   * Constructeur
   * @param pErrorDetail : le code erreur
   */
  public FlatMapperException(ErrorDetail pErrorDetail)
  {
    super(pErrorDetail);
  }
   ...
   */
  public FlatMapperException(ErrorDetail pErrorDetail, Throwable pCause)
  {
   ...
   * @param pCause : la cause d'origine de cette exception
   */
  public FlatMapperException(ErrorDetail pErrorDetail, Object[] pParams, Throwable pCause)
  {
   ...
   * @param pParams : les paramètres décrivant le contexte de l'exception
   */
  public FlatMapperException(ErrorDetail pErrorDetail, Object[] pParams)
  {
