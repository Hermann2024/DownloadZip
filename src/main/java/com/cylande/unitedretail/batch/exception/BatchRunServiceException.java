...
public class BatchRunServiceException extends BusinessServiceException
{
  /**
   * Constructor
   ...
   */
  public BatchRunServiceException(ErrorDetail pErrorDetail, Locale pLocale)
  {
   ...
   * @parma locale Localization used for message translation
   */
  public BatchRunServiceException(ErrorDetail pErrorDetail, Throwable pCause, Locale pLocale)
  {
   ...
   * @parma locale Localization used for message translation
   */
  public BatchRunServiceException(ErrorDetail pErrorDetail, Object[] pParams, Throwable pCause, Locale pLocale)
  {
   ...
   * @parma locale Localization used for message translation
   */
  public BatchRunServiceException(ErrorDetail pErrorDetail, Object[] pParams, Locale pLocale)
  {
